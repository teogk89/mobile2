...
var WEB_ADDRESS='.json_encode(WEB_ADDRESS).',

';

if (FULL_VERSION){

echo"collect_start_date=".json_encode($collect_start_date).",
	validDays=".json_encode($valid_days).",
	pickup_times=".json_encode($pickup_times).",

";
}

echo"	YES=".json_encode(YES).",
	NO=".json_encode(NO).",
